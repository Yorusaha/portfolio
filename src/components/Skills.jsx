...
import { SiFramer, SiGodotengine } from "react-icons/si";
...
export default function Skills() {
  const [skills] = useState([
    ...
    { id: 4, name: "Tailwind", icon: <RiTailwindCssFill size={50} /> },
    { id: 5, name: "HTML", icon: <FaHtml5 size={50} /> },
    { id: 6, name: "CSS", icon: <FaCss3Alt size={50} /> },
    { id: 7, name: "Figma", icon: <CgFigma size={50} /> },
    { id: 8, name: "Framer Motion", icon: <SiFramer size={50} /> },
    { id: 9, name: "Godot", icon: <SiGodotengine size={50} /> },
  ]);
        ...
        <div className="px-5 lg:px-28 mt-10 space-y-8">
          ...
          <div className="border border-gray-300 p-6 rounded-lg hover:border-red-600 transition">
            <h2 className="text-xl lg:text-2xl font-semibold">
              Game Development Student at{" "}
              <span className="text-red-600">SMK Telkom Bandung</span>
            </h2>
            <p className="text-gray-500 mt-3">
              Vocational High School majoring in Game Development, Bandung
            </p>
          </div>
